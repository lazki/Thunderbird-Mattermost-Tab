...
* `git clone https://github.com/mgenet/Thunderbird-Mattermost-INRIA-Tab`
* `cd ./Thunderbird-Mattermost-INRIA-Tab`
* `VERSION=$(cat ./manifest.json | jq --raw-output '.version')`
* `zip -r "../Thunderbird-Mattermost-INRIA-Tab-${VERSION}.xpi" *`
